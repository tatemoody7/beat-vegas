...
# real-money BET, card.py::build_item blocks the card's BET tier (blocker
# early_season) and verdict.ts keeps the board at WATCH. Mirrored in verdict.ts and pinned by tests/test_gate_parity.py.
...
CONTEXT_NUMERIC_KEYS = (
    ...
    "combined_fh_offense",
    "combined_fh_defense",
    # prior games played this season (etl/features.py cumcount, leak-free):
    # the web's "early season" tag reads min(h, a) < 2.
    "h_games_played",
    "a_games_played",
) + SITUATIONAL_KEYS
