...
class CFBDClient:
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None,
        ...
        self.base_url = (base_url or cfg.get("base_url")
                         or "https://api.collegefootballdata.com").rstrip("/")
    ...
    # --- endpoints -------------------------------------------------------
    def games(self, year: int, week: Optional[int] = None,
              season_type: str = "regular", division: str = "fbs") -> List[Dict]:
    ...
    def lines(self, year: int, week: Optional[int] = None,
    ...
    def advanced_season_stats(self, year: int, team: Optional[str] = None,
