...
class OddsAPIClient:
    def __init__(self, api_key: Optional[str] = None, timeout: int = 30):
        ...
        self.base_url = (cfg.get("base_url")
                         or "https://api.the-odds-api.com/v4").rstrip("/")
    ...
    def _credits(self, resp: requests.Response) -> Credits:
        ...
        c = Credits(remaining=_int("x-requests-remaining"),
    ...
    def list_events(self) -> List[Dict[str, Any]]:
        ...
        resp = requests.get(url, params={"apiKey": self.api_key,
                                         "dateFormat": "iso"},
...
def normalize_first_half(events: List[Dict[str, Any]],
                         books: Optional[List[str]] = None) -> List[Dict[str, Any]]:
