...
def test_assign_opening_line_prefers_real_then_proxy():
    ...
    snaps = pd.DataFrame({
        ...
        "captured_at": [datetime(2025, 10, 1, 9), datetime(2025, 10, 3, 9),
                        datetime(2025, 10, 1, 9), datetime(2025, 10, 3, 9)],
    })
...
def test_assign_opening_line_empty_snapshots_all_proxy():
    games = pd.DataFrame({"id": [1], "full_game_total": [47.0],
                          "first_half_total": [20]})
