  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <div className="bv-card mb-6 p-4">
        <h2 className="mb-3 text-sm font-semibold text-[var(--text)]">Your record</h2>
        {record ? (
          <div className="flex flex-wrap items-baseline gap-x-10 gap-y-2">
            <div>
              ...
              <span className="text-sm text-[var(--text-dim)]">{record.record}</span>
            </div>
            <div className="text-sm text-[var(--text-muted)]" title="Profit in units. 1 unit = one standard bet.">
              Units{" "}
              <b
                className="font-mono tabular-nums"
                style={{ color: record.units.startsWith("-") ? "#dc2626" : "#16a34a" }}
              >
                {record.units}
              </b>
            </div>
            <div className="text-sm text-[var(--text-muted)]" title="Average line value (CLV): positive = the line moved your way after you'd bet.">
              Avg line value{" "}
              <b className="font-mono tabular-nums text-[var(--text)]">{record.clv}</b>
            </div>
          </div>
        ) : (
      ...
      <h2 className="mb-2 text-sm font-semibold text-[var(--text)]">Log a pick</h2>
      <LogPickForm slate={slate} />

      <h2 className="mb-2 mt-7 text-sm font-semibold text-[var(--text)]">History</h2>
